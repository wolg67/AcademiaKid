...
const courses: Course[] = [
  {
    ...
    fullDescription: 'Python es el lenguaje perfecto para iniciar tu viaje en la programación. Con una sintaxis clara y sencilla, aprenderás a crear juegos, aplicaciones y resolver problemas reales mientras desarrollas tu lógica computacional. Todo adaptado para niños y jóvenes.',
    ...
    features: ['Clases en vivo y virtuales', 'Proyectos semanales', 'Certificado incluido', 'Soporte 24/7'],
  },
  {
    id: 'arduino',
    name: 'Arduino',
    description: 'Programación física y electrónica divertida',
    fullDescription: 'Con Arduino, la programación cobra vida. Aprende a controlar luces, motores, sensores y crear proyectos electrónicos increíbles mientras entiendes cómo funciona la tecnología que nos rodea. Todo adaptado para niños y jóvenes.',
    ...
    features: ['Clases en vivo y virtuales', 'Proyectos hands-on', 'Mentoría personalizada', 'Comunidad activa'],
  },
  {
    id: 'scratch',
    name: 'Scratch',
    description: 'Programación visual con bloques de colores',
    fullDescription: 'Scratch hace que programar sea como jugar con bloques de construcción. Arrastra y suelta bloques de colores para crear animaciones, juegos y historias interactivas. ¡Perfecto para los más pequeños! Todo adaptado para niños y jóvenes.',
    ...
    features: ['Clases en vivo y virtuales', '100% visual y divertido', 'Sin código escrito', 'Proyectos creativos', 'Para todas las edades'],
  },
  {
    id: 'html',
    name: 'HTML',
    description: 'Crea la estructura de tus propios sitios web',
    fullDescription: 'HTML es la base de cada sitio web en el mundo. Aprende a usar etiquetas para crear contenido, organizar estructuras y dar tus primeros pasos en el emocionante mundo del desarrollo web profesional. Todo adaptado para niños y jóvenes.',
    ...
    features: ['Clases en vivo y virtuales', 'Proyectos reales', 'Portfolio personal', 'Recursos premium', 'Guías paso a paso'],
  },
  {
    id: 'css',
    name: 'CSS',
    description: 'Diseña y da estilo a la web con colores y animaciones',
    fullDescription: 'Si HTML es el esqueleto, CSS es la piel y el estilo. Aprende a transformar sitios web aburridos en experiencias visualmente asombrosas usando colores, fuentes, layouts modernos y animaciones espectaculares. Todo adaptado para niños y jóvenes.',
    logo: '/assets/css.svg',
    color: 'css',
    ...
    features: ['Clases en vivo y virtuales','Diseño moderno', 'Laboratorios visuales', 'Feedback de expertos', 'Templates listos'],
  },
  {
    id: 'javascript',
    name: 'JavaScript',
    description: 'Dale vida y magia a tus páginas web con lógica',
    fullDescription: 'JavaScript es el cerebro de la web. Aprende a programar la interactividad, crear aplicaciones dinámicas y controlar cada elemento de tu sitio web. ¡El lenguaje más popular del mundo te espera! Todo adaptado para niños y jóvenes.',
    logo: '/assets/js.svg',
    color: 'js',
    ...
    features: ['Clases en vivo y virtuales', 'Desafíos de código', 'App real al final', 'Comunidad dev', 'Acceso de por vida'],
  },
  {
    id: 'sql',
    name: 'SQL',
    description: 'Gestión de bases de datos como un experto',
    fullDescription: 'SQL es el lenguaje que permite hablar con las bases de datos. Aprende a organizar, buscar y analizar datos como un verdadero profesional de la tecnología. ¡Una habilidad muy demandada! Todo adaptado para niños y jóvenes.',
    logo: '/assets/sql.svg',
    color: 'sql',
    ...
    features: ['Clases en vivo y virtuales', 'Bases de datos reales', 'Ejercicios prácticos', 'Casos de negocio', 'Preparación profesional'],
  },
];
          ...
          <div className="bg-white rounded-3xl shadow-card p-8 md:p-12">
            ...
            <div className="text-center">
              <p className="text-lg text-gray-700 leading-relaxed">
                Mi nombre es William Lozano, Soy profesor con <span className="font-bold text-python">30+ años de experiencia</span> enseñando a estudiantes de todos los niveles. En continua actualización en la Programación, con dominio de varios lenguajes. Me especializo en enseñar a programar desde cero. Y ahora con una didáctica Centrada en el Desarrollo de las competencias necesarias para el Aprendizaje de estos lenguajes de Programación para Niños y Jóvenes. Comienza aprender{' '}
